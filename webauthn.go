...
type (
	...
	AuthenticatorAttestationResponse struct {
	...
	AuthenticatorAssertionResponse struct {
		// ClientDataJSON contains the JSON-compatible serialization of client data passed to the authenticator by the
	...
	PublicKeyAssertionCredential struct {
	...
	PublicKeyCreationCredential struct {
		// ID is the base64url encoding of the RawID.
		ID string `json:"id"`
		// Type is "public-key".
		Type string `json:"type"`
	...
	PublicKeyCredentialDescriptor struct {
